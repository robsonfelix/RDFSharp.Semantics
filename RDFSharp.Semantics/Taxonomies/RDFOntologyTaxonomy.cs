...
namespace RDFSharp.Semantics {
    ...
    /// <summary>
    /// RDFOntologyTaxonomy represents a register for storing a generic taxonomy relationship within an ontology.
    /// </summary>
    public class RDFOntologyTaxonomy: IEnumerable<RDFOntologyTaxonomyEntry> {
        ...
        internal RDFGraph ToRDFGraph(RDFSemanticsEnums.RDFOntologyInferenceExportBehavior infexpBehavior) {
            ...
            //Taxonomy entries
            foreach (var te in this) {
                switch (infexpBehavior) {

                    //Do not export semantic inferences
                    case RDFSemanticsEnums.RDFOntologyInferenceExportBehavior.None:
                    ...
                    case RDFSemanticsEnums.RDFOntologyInferenceExportBehavior.OnlyModel:
                    ...
                    case RDFSemanticsEnums.RDFOntologyInferenceExportBehavior.OnlyData:
                    ...
                    case RDFSemanticsEnums.RDFOntologyInferenceExportBehavior.ModelAndData:
                        result.AddTriple(te.ToRDFTriple());
                        break;
    ...
    /// <summary>
    /// RDFOntologyTaxonomy represents an entry of a generic taxonomy relationship within an ontology.
    /// </summary>
    public class RDFOntologyTaxonomyEntry:IEquatable<RDFOntologyTaxonomyEntry> {
        ...
        #region Methods
        /// <summary>
        /// Marks this taxonomy entry as the given type of semantic inference
        /// </summary>
        ...
        internal RDFTriple ToRDFTriple() {
            if (this.TaxonomyObject.Value is RDFLiteral) {
