    ...
    internal static class RDFSemanticsUtilities {
        ...
        internal static RDFOntologyClassModel EnlistSubClassesOf_Core(RDFOntologyClass ontClass, 
            ...
            foreach(var sc in result1) {
                result2 = result2.UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf(sc, classModel)
                                                .UnionWith(RDFBASEOntologyReasoningHelper.EnlistSubClassesOf(sc, classModel)));
            }
        ...
        internal static RDFOntologyClassModel EnlistSuperClassesOf_Core(RDFOntologyClass ontClass, 
            ...
            foreach(var sc in result1) {
                result2 = result2.UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf(sc, classModel)
                                                .UnionWith(RDFBASEOntologyReasoningHelper.EnlistSuperClassesOf(sc, classModel)));
            }
        ...
        internal static RDFOntologyClassModel EnlistDisjointClassesWith_Core(RDFOntologyClass ontClass, 
            ...
            var compatibleCls = RDFBASEOntologyReasoningHelper.EnlistSuperClassesOf(ontClass, classModel)
                                    .UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf(ontClass, classModel));
        ...
        internal static RDFOntologyPropertyModel EnlistSubPropertiesOf_Core(RDFOntologyProperty ontProperty, 
            ...
            foreach(var sp in result1) {
                result2 = result2.UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentPropertiesOf(sp, propertyModel)
                                                .UnionWith(RDFBASEOntologyReasoningHelper.EnlistSubPropertiesOf(sp, propertyModel)));
            }
        ...
        internal static RDFOntologyPropertyModel EnlistSuperPropertiesOf_Core(RDFOntologyProperty ontProperty, 
            ...
            foreach(var sp in result1) {
                result2 = result2.UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentPropertiesOf(sp, propertyModel)
                                                .UnionWith(RDFBASEOntologyReasoningHelper.EnlistSuperPropertiesOf(sp, propertyModel)));
            }
        ...
        internal static RDFOntologyData EnlistDifferentFactsFrom_Core(RDFOntologyFact ontFact,
            ...
            foreach (var     sa in RDFBASEOntologyReasoningHelper.EnlistSameFactsAs(ontFact, data)) {
        ...
        internal static RDFOntologyData EnlistMembersOfRestriction(RDFOntologyRestriction ontRestriction, 
            ...
            var compProps  = RDFBASEOntologyReasoningHelper.EnlistSubPropertiesOf(ontRestriction.OnProperty, ontology.Model.PropertyModel)
                                 .UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentPropertiesOf(ontRestriction.OnProperty, ontology.Model.PropertyModel))
            ...
            #region AllValuesFrom
                ...
                var compClasses = RDFBASEOntologyReasoningHelper.EnlistSubClassesOf(((RDFOntologyAllValuesFromRestriction)ontRestriction).FromClass, ontology.Model.ClassModel)
                                      .UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf(((RDFOntologyAllValuesFromRestriction)ontRestriction).FromClass, ontology.Model.ClassModel))
                ...
                foreach (var tEntry in fTaxonomy) {
                    ...
                    foreach (var objFactClassType in objFactClassTypes) {
                        var compObjFactClassTypes = RDFBASEOntologyReasoningHelper.EnlistSubClassesOf((RDFOntologyClass)objFactClassType.TaxonomyObject, ontology.Model.ClassModel)
                                                        .UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf((RDFOntologyClass)objFactClassType.TaxonomyObject, ontology.Model.ClassModel))
            ...
            #region SomeValuesFrom
                ...
                //Enlist the classes which are compatible with the restricted "FromClass"
                var compClasses = RDFBASEOntologyReasoningHelper.EnlistSubClassesOf(((RDFOntologySomeValuesFromRestriction)ontRestriction).FromClass, ontology.Model.ClassModel)
                                      .UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf(((RDFOntologySomeValuesFromRestriction)ontRestriction).FromClass, ontology.Model.ClassModel))
            ...
            #region HasValue
                ...
                if (((RDFOntologyHasValueRestriction)ontRestriction).RequiredValue.IsFact()) {
                    ...
                    var compFacts = RDFBASEOntologyReasoningHelper.EnlistSameFactsAs((RDFOntologyFact)((RDFOntologyHasValueRestriction)ontRestriction).RequiredValue, ontology.Data)
        ...
        internal static RDFOntologyData EnlistMembersOfEnumerate(RDFOntologyEnumerateClass ontEnumClass, 
            ...
            foreach (var   tEntry in enTaxonomy) {
                ...
                if  (tEntry.TaxonomySubject.IsEnumerateClass() && tEntry.TaxonomyObject.IsFact()) {
                     result= result.UnionWith(RDFBASEOntologyReasoningHelper.EnlistSameFactsAs((RDFOntologyFact)tEntry.TaxonomyObject, ontology.Data))
        ...
        internal static RDFOntologyData EnlistMembersOfComposite(RDFOntologyClass ontCompClass, 
            ...
            if (ontCompClass      is RDFOntologyIntersectionClass) {
                ...
                foreach (var       tEntry in iTaxonomy) {
                    if  (firstIter) {
                        result     = RDFBASEOntologyReasoningHelper.EnlistMembersOf((RDFOntologyClass)tEntry.TaxonomyObject, ontology);
                        firstIter  = false;
                    }
                    else {
                        result     = result.IntersectWith(RDFBASEOntologyReasoningHelper.EnlistMembersOf((RDFOntologyClass)tEntry.TaxonomyObject, ontology));
                    }
                }
            ...
            //Union
                ...
                foreach (var       tEntry in uTaxonomy) {
                    result         = result.UnionWith(RDFBASEOntologyReasoningHelper.EnlistMembersOf((RDFOntologyClass)tEntry.TaxonomyObject, ontology));
                }
            ...
            //Complement
                ...
                result             = ontology.Data.DifferenceWith(RDFBASEOntologyReasoningHelper.EnlistMembersOf(((RDFOntologyComplementClass)ontCompClass).ComplementOf, ontology));
            }
        ...
        internal static RDFOntologyData EnlistMembersOfLiteralCompatibleClass(RDFOntologyClass ontClass, 
            ...
            #region Pure Literal
            else if (ontClass.Equals(rdfsLiteral) || RDFBASEOntologyReasoningHelper.IsEquivalentClassOf(ontClass, rdfsLiteral, ontology.Model.ClassModel)) {
            ...
            #region Derived Literal
                ...
                if (ontClass.Equals(xsdString) || RDFBASEOntologyReasoningHelper.IsEquivalentClassOf(ontClass, xsdString, ontology.Model.ClassModel)) {
                    foreach(var ontLit   in ontology.Data.Literals.Values) {
                    ...
                    foreach(var ontLit in ontology.Data.Literals.Values.Where(l => l.Value is RDFTypedLiteral)) {
                        ...
                        if (dTypeClass != null) {
                            if (dTypeClass.Equals(ontClass) 
                                || RDFBASEOntologyReasoningHelper.IsSubClassOf(dTypeClass,        ontClass, ontology.Model.ClassModel) 
                                || RDFBASEOntologyReasoningHelper.IsEquivalentClassOf(dTypeClass, ontClass, ontology.Model.ClassModel)) {
                                result.AddLiteral(ontLit);
                            }
                        }
        ...
        internal static RDFOntologyData EnlistMembersOfClass(RDFOntologyClass ontClass, 
            ...
            var compCls    = RDFBASEOntologyReasoningHelper.EnlistSubClassesOf(ontClass, ontology.Model.ClassModel)
                                .UnionWith(RDFBASEOntologyReasoningHelper.EnlistEquivalentClassesOf(ontClass, ontology.Model.ClassModel))
                                    .AddClass(ontClass);
            ...
            foreach (var   tEntry in fTaxonomy) {
                ...
                if (tEntry.TaxonomySubject.IsFact()) {
                    result = result.UnionWith(RDFBASEOntologyReasoningHelper.EnlistSameFactsAs((RDFOntologyFact)tEntry.TaxonomySubject, ontology.Data))
        ...
        internal static RDFOntology FromRDFGraph(RDFGraph ontGraph) {
            ...
            if (ontGraph         != null) {
                ...
                foreach (var c     in ontology.Model.ClassModel.Where(cls => !RDFBASEOntology.Instance.Model.ClassModel.Classes.ContainsKey(cls.PatternMemberID)
                                                                                && !RDFBASEOntologyReasoningHelper.IsLiteralCompatibleClass(cls, ontology.Model.ClassModel))) {
                ...
                foreach (var t in versionInfo.SelectTriplesBySubject((RDFResource)ontology.Value)) {
                    if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                         ontology.AddVersionInfoAnnotation(((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                    }
                    else {
                ...
                foreach (var t in comment.SelectTriplesBySubject((RDFResource)ontology.Value)) {
                    if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                         ontology.AddCommentAnnotation(((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                    }
                    else {
                ...
                foreach (var t in label.SelectTriplesBySubject((RDFResource)ontology.Value)) {
                    if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                         ontology.AddLabelAnnotation(((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                    }
                    else {
                ...
                foreach (var t in seeAlso.SelectTriplesBySubject((RDFResource)ontology.Value)) {
                    if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                         ontology.AddSeeAlsoAnnotation(((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                    }
                    else {
                ...
                foreach (var t in isDefinedBy.SelectTriplesBySubject((RDFResource)ontology.Value)) {
                    if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                         ontology.AddIsDefinedByAnnotation(((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                    }
                    else {
                ...
                foreach (var c in ontology.Model.ClassModel) {
                    ...
                    foreach (var t in versionInfo.SelectTriplesBySubject((RDFResource)c.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Model.ClassModel.AddVersionInfoAnnotation(c, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach (var t in label.SelectTriplesBySubject((RDFResource)c.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Model.ClassModel.AddLabelAnnotation(c, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach (var t in seeAlso.SelectTriplesBySubject((RDFResource)c.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Model.ClassModel.AddSeeAlsoAnnotation(c, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                            RDFOntologyResource resource = ontology.Model.ClassModel.SelectClass(t.Object.ToString());
                            if (resource                == null) {
                    ...
                    foreach (var t in isDefinedBy.SelectTriplesBySubject((RDFResource)c.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Model.ClassModel.AddIsDefinedByAnnotation(c, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                            RDFOntologyResource isDefBy = ontology.Model.ClassModel.SelectClass(t.Object.ToString());
                            if (isDefBy                == null) {
                ...
                foreach(var p in ontology.Model.PropertyModel) {
                    ...
                    foreach(var t in versionInfo.SelectTriplesBySubject((RDFResource)p.Value)) {
                        if (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                            ontology.Model.PropertyModel.AddVersionInfoAnnotation(p, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach(var t in comment.SelectTriplesBySubject((RDFResource)p.Value)) {
                        if (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                            ontology.Model.PropertyModel.AddCommentAnnotation(p, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach(var t in label.SelectTriplesBySubject((RDFResource)p.Value)) {
                        if (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                            ontology.Model.PropertyModel.AddLabelAnnotation(p, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach(var t in seeAlso.SelectTriplesBySubject((RDFResource)p.Value)) {
                        if (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                            ontology.Model.PropertyModel.AddSeeAlsoAnnotation(p, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                            RDFOntologyResource resource = ontology.Model.ClassModel.SelectClass(t.Object.ToString());
                            if (resource                == null) {
                    ...
                    foreach(var t in isDefinedBy.SelectTriplesBySubject((RDFResource)p.Value)) {
                        if (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                            ontology.Model.PropertyModel.AddIsDefinedByAnnotation(p, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                            RDFOntologyResource isDefBy = ontology.Model.ClassModel.SelectClass(t.Object.ToString());
                            if (isDefBy                == null) {
                ...
                foreach (var f in ontology.Data) {
                    ...
                    foreach (var t in versionInfo.SelectTriplesBySubject((RDFResource)f.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Data.AddVersionInfoAnnotation(f, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach (var t in comment.SelectTriplesBySubject((RDFResource)f.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Data.AddCommentAnnotation(f, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach (var t in label.SelectTriplesBySubject((RDFResource)f.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Data.AddLabelAnnotation(f, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                    ...
                    foreach (var t in seeAlso.SelectTriplesBySubject((RDFResource)f.Value)) {
                        if  (t.TripleFlavor  == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Data.AddSeeAlsoAnnotation(f, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                            RDFOntologyResource resource = ontology.Model.ClassModel.SelectClass(t.Object.ToString());
                            if (resource                == null) {
                    ...
                    foreach (var t in isDefinedBy.SelectTriplesBySubject((RDFResource)f.Value)) {
                        if  (t.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL) {
                             ontology.Data.AddIsDefinedByAnnotation(f, ((RDFLiteral)t.Object).ToRDFOntologyLiteral());
                        }
                        else {
                            RDFOntologyResource isDefBy = ontology.Model.ClassModel.SelectClass(t.Object.ToString());
                            if (isDefBy                == null) {
