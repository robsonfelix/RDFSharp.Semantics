        ...
        public static Boolean IsLiteralCompatibleClass(RDFOntologyClass ontClass, 
            ...
            if (ontClass != null && classModel != null) {
                result    = (ontClass.IsDataRangeClass() 
                             || ontClass.Equals(RDFSOntology.Instance.Model.ClassModel.SelectClass(RDFVocabulary.RDFS.LITERAL.ToString())) 
                             || IsSubClassOf(ontClass, RDFSOntology.Instance.Model.ClassModel.SelectClass(RDFVocabulary.RDFS.LITERAL.ToString()), classModel) 
                             || IsEquivalentClassOf(ontClass, RDFSOntology.Instance.Model.ClassModel.SelectClass(RDFVocabulary.RDFS.LITERAL.ToString()), classModel));
            }
            return result;
        }
        #endregion
